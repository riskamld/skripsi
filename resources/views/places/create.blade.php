...
@section('page-title', 'Add New Place')
@section('page-subtitle', 'Create a new place entry')
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('opening_hours') is-invalid @enderror"
                                  id="opening_hours" name="opening_hours" rows="3">{{ old('opening_hours') }}</textarea>
                        @error('opening_hours')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="url" class="form-control @error('image_' . $i) is-invalid @enderror"
                                       id="image_{{ $i }}" name="image_{{ $i }}" value="{{ old('image_' . $i) }}">
                                @error('image_' . $i)
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('parser_version') is-invalid @enderror"
                               id="parser_version" name="parser_version" value="{{ old('parser_version', '1.0') }}">
