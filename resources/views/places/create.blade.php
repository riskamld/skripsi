@extends('layouts.app')
@section('title', 'Tambah Tempat — Mafaza Fortuna')
@section('page-title', 'Tambah Tempat')

@section('content')

<div class="mb-16">
    <a href="{{ route('places.index') }}" class="btn btn-secondary btn-sm"><i class="fas fa-arrow-left"></i> Kembali ke Data Tempat</a>
</div>
...
<div class="card mb-16">
    <div class="card-header"><i class="fas fa-plus" style="color:var(--ac);margin-right:6px"></i>Tambah Tempat Baru</div>
    <div class="card-body">
        <div class="grid grid-2" id="grid-basic">
            ...
            <div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="review_count" name="review_count" value="{{ old('review_count') }}">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="opening_hours" name="opening_hours" rows="3">{{ old('opening_hours') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input type="url" class="form-control" id="maps_url" name="maps_url" value="{{ old('maps_url') }}">
        ...
        <div class="grid grid-2 mt-12">
            <div class="form-group">
                ...
                <input type="number" step="any" class="form-control" id="lat" name="lat" value="{{ old('lat') }}">
            ...
            <div class="form-group">
                ...
                <input type="number" step="any" class="form-control" id="lng" name="lng" value="{{ old('lng') }}">
        ...
        <div class="grid grid-4" id="grid-images">
            ...
            <div class="form-group">
                ...
                <input type="url" class="form-control" id="image_{{ $i }}" name="image_{{ $i }}" value="{{ old('image_' . $i) }}">
        ...
        <div class="grid grid-2 mt-12">
            <div class="form-group">
                <label class="text-sm d-flex align-center gap-6" style="cursor:pointer">
                    <input type="checkbox" id="is_valid" name="is_valid" value="1" {{ old('is_valid', true) ? 'checked' : '' }}>
                    Valid / Relevan
                </label>
            </div>
            <div class="form-group">
                <label class="form-label" for="parser_version">Versi Parser</label>
                <input type="text" class="form-control" id="parser_version" name="parser_version" value="{{ old('parser_version', '1.0') }}">
    ...
    <div class="card-footer d-flex gap-8">
        <button type="submit" class="btn btn-primary btn-sm"><i class="fas fa-save"></i> Simpan Tempat</button>
        <a href="{{ route('places.index') }}" class="btn btn-secondary btn-sm"><i class="fas fa-times"></i> Batal</a>
    </div>
</div>
</form>
